...
public class MediaGroupPost extends TextPost implements Sendable {
    ...
    public MediaGroupPost() {
    }

    @Override
    public MediaGroupPost setSourceName(String sourceName) {
        this.sourceName = sourceName;
        return this;
    }

    @Override
    public MediaGroupPost setText(String text) {
        super.setText(text);
        return this;
    }

    @Override
    public MediaGroupPost setReplyPostId(int replyPost) {
        super.setReplyPostId(replyPost);
        return this;
    }

    @Override
    public MediaGroupPost setInlineKeyboardMarkup(InlineKeyboardMarkup inlineKeyboardMarkup) {
        super.setInlineKeyboardMarkup(inlineKeyboardMarkup);
        return this;
    }

    @Override
    public MediaGroupPost setPrintableAttachmentList(List<Printable> printableAttachmentList) {
